...
public class Constant {
	...
	public static String Driver_ZSI, Driver_ODS, url_ZSI, url_ODS, user_ZSI, user_ODS, password_ZSI, password_ODS, PathTestData, PathFile, FileTestData, SheetNameZSI, SheetNameODS;
	...
	public static void getConstant() throws IOException{
	 ...
	 SheetNameZSI = getConstants[11];
	 SheetNameODS = getConstants[12];
